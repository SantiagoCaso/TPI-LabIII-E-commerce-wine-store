        ...
        <CardActionArea>
          ...
          <CardContent className="CardContent">
            ...
            <Typography variant="body2" color="text.secondary">
              ...
              the same way, to the production of one of humanity's most
              emblematic elixirs: wine. From the hills of Tuscana to the vast
              plains of Mendoza (Argentina), vineyards are not only a testimony
              of the connection between a man and the land, but also a tribute
              to the art of patiencie and care.
            </Typography>
          </CardContent>
        </CardActionArea>
      </Card>
